...
it('easeElasticIn(t) is the same as elasticIn.amplitude(1).period(0.3)(t)', () => {
  assert.strictEqual(
    easeElasticIn(0.1),
    easeElasticIn.amplitude(1).period(0.3)(0.1)
  );
  assert.strictEqual(
    easeElasticIn(0.2),
    easeElasticIn.amplitude(1).period(0.3)(0.2)
  );
  assert.strictEqual(
    easeElasticIn(0.3),
    easeElasticIn.amplitude(1).period(0.3)(0.3)
  );
});
...
it('easeElasticIn.amplitude(a).period(p)(t) coerces t, a and p to numbers', () => {
  assert.strictEqual(
    easeElasticIn.amplitude('1.3').period('0.2')('.9'),
